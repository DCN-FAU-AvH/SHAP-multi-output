...
train linear and nonlinear multi-output models,

compute SHAP values for each output,

aggregate Mean Absolute SHAP values,

generate bar plots and beeswarm plots,

and construct publication-ready composite figures.
